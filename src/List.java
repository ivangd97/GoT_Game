...
public class List <type extends Comparable <type>>{
	...
	*/
	public void sortedAdd(type Data) {
		...
		//los metodos de otras clases se encargan de aÃ±adir los tipos en orden
	}
	 ...
	 *
	 * @param Data valor que se va a insertar
	 * @param searchedValue valor delante del cual se insertarÃ¡ el nuevo dato
	 */
	...
	/**
	 * Permite eliminar el Data almacenado en una posiciÃ³n dada
	 *
	 * @param index posiciÃ³n del Data que se eliminarÃ¡
	 * @return el dato que estÃ¡ al inicio de la lista
	 */
